...
def test_choices():
    c1 = FISH.choices()
    assert c1 == {'Pike Family': 'PkF', 'Pike Family/Northern Pike': 'NPK', 'Pike Family/Muskie': 'MSK', 'Pike Family/Pickerel': 'PKL', 'Perch Family': 'PeF', 'Perch Family/Common Perch': 'PCH', 'Perch Family/Yellow Perch': 'YPH', 'Perch Family/Walleye': 'WLY', 'Perch Family/Sagger': 'SGR', 'Carp Family': 'CrF', 'Carp Family/Common Carp': 'CRP', 'Carp Family/Wild Carp': 'WCP', 'Carp Family/Ide': 'IDE', 'Carp Family/Bream': 'BRM', 'Carp Family/Roach': 'RCH'}
